...
\[ I_f \cong \left\{ \begin{array}{lcc}
            0 &  \text{si}  & \mathbf{RA} \ \text{no explora estados en esa fase} \\
            0 < I_f < 0.5 &  \text{si}  & \mathbf{RA} \ \text{explora \textbf{menos} estados que } \mathbf{BFS} \text{ en esa fase} \\
            0.5 &  \text{si}  & \mathbf{RA} \ \text{explora \textbf{igual} cantidad de estados que BFS en la fase} \\
            0.5 < I_f < 1 &  \text{si}  & \mathbf{RA} \ \text{explora \textbf{más} estados que } \mathbf{BFS} \text{ en esa fase} \\
            1 &  \text{si}  & \mathbf{BFS} \ \text{no explora estados en esa fase}
             \end{array}
   \right. \]
