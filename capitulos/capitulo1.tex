...
% TODO(guía de lectura): REESCRIBIR a la estructura NUEVA de capítulos:
%   Cap. 2  Antecedentes (LTS, control safe/non-blocking, síntesis
%           composicional, WSOE).
%   Cap. 3  Branching bisimilarity (definición, relación con otras
%           equivalencias, algoritmo O(m log n) de Groote et al.).
%   Cap. 4  Equivalencia entre WSOE y branching bisimilarity (teorema +
%           demostración) -> aporte teórico central.
%   Cap. 5  Adaptación e implementación en MTSA.
%   Cap. 6  Experimentación y resultados (WSOE vs branching bisimilarity).
%   Cap. 7  Conclusiones.
% Los párrafos de abajo describen la estructura VIEJA (caps. 3-6 del molde)
