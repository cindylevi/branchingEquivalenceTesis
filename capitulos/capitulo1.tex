...
% Seguidamente, en el capı́tulo 5, exponemos detalles sobre la implementación, MTSA,
% heurı́sticas diseñadas para testeo y detalles sobre la baterı́a de tests, desarrollada utilizando
% TDD (Test Driven Development).
% Como paso final en el capı́tulo 6 presentamos el benchmark utilizado y resultados de
% performance; tanto entre distintos resultados de SCD como versus otros algoritmos del
% estado del arte.
% Finalmente, en el capı́tulo 7 listamos las conclusiones y aportes del trabajo presentado.
