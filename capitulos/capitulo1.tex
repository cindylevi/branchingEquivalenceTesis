...
El paso de minimización no es un detalle de implementación sino que es el paso que se ejecuta una y otra vez, una vez por cada iteración del procedimiento. Los autores de  \cite{compositional} identifican a este paso como el cuello de botella del proceso de sintesis composicional.
