...
\begin{itemize}
    ...
    operaciones sobre esos diagramas. Un ejemplo es Sigref~\cite{sigref}, una caja de herramientas
    que implementa varias de las
    equivalencias de bisimulación, entre ellas \textit{branching} y
    \textit{weak bisimulation}. Esa representación cambia por completo el
