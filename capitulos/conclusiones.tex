...
\begin{itemize}
    ...
    sobre~\cite{groote2019} tanto en tiempo como en espacio. Además, el mismo grupo continúa
    ...
    en Java y ver si los tiempos presentan alguna mejora.
    ...
    ya no hay un costo constante por transición individual, sino que el costo depende del tamaño
